...
\title{Pushing Blocks by Sweeping Lines} % Geben Sie hier den Titel Ihrer Arbeit an.

\author{Philipp Geier} % Geben Sie Ihren Namen an.
\semester{WiSe 2022/23}
\newcommand{\abgabedatum}{14. April 2023} % Hier wird das Abgabedatum angepasst
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.25\textwidth]{2048}
	\caption{Spiel 2048}
	\quelle\cite{2048}
	\label{fig:2}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.29\textwidth]{labyrinth}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.25\textwidth]{kanonisch}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.25\textwidth]{kompakt}
...
\begin{figure}[ht]
	...
	\begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{kmpkt_1}
    \end{subfigure}%
    \begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{kmpkt_0}
    \end{subfigure}
...
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{kmpkt_2}
    \end{subfigure}%
    \begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{kmpkt_5}
    \end{subfigure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{q05}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{q06}
...
\begin{figure}[ht]
	...
	\begin{subfigure}{.3\textwidth}
		\includegraphics[width=0.75\textwidth]{Unlabeled}
    \end{subfigure}%
    \begin{subfigure}{.3\textwidth}
		\includegraphics[width=0.7\textwidth]{kompakt}
    \end{subfigure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.23\textwidth]{labeled}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.23\textwidth]{kompress}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.23\textwidth]{Unlabeled}
...
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.3\textwidth}
		\includegraphics[width=0.73\textwidth]{z00}
		\caption{Start}
    \end{subfigure}%
    \begin{subfigure}{.3\textwidth}
		\includegraphics[width=0.65\textwidth]{z02}
		\caption{L-Form}
    \end{subfigure}%
    \begin{subfigure}{.3\textwidth}
		\includegraphics[width=0.35\textwidth]{z03}
		\caption{Ende}
    \end{subfigure}%
...
\begin{figure}
	...
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=0.75\textwidth]{pic1_edited}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
		\includegraphics[width=0.75\textwidth]{pic2_edited}
    \end{subfigure}
\end{figure}
\begin{figure}
	\centering
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=0.75\textwidth]{pic3_edited}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
		\includegraphics[width=0.75\textwidth]{pic4_edited}
    \end{subfigure}
\end{figure}
\begin{figure}
	\centering
	\begin{subfigure}{.5\textwidth}
		\includegraphics[width=0.75\textwidth]{pic5_edited}
    \end{subfigure}%
    \begin{subfigure}{.5\textwidth}
		\includegraphics[width=0.75\textwidth]{pic6_edited}
    \end{subfigure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.7\textwidth]{fun2022}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{dual}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.29\textwidth]{b00}
...
\begin{figure}[ht]
	...
	\begin{subfigure}{.25\textwidth}
		\includegraphics[width=0.75\textwidth]{m00}
    \end{subfigure}%
    \begin{subfigure}{.25\textwidth}
		\includegraphics[width=0.75\textwidth]{m08}
    \end{subfigure}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.23\textwidth]{k00}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.23\textwidth]{k15}
...
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{picPerm2_edited}
    \end{subfigure}%
    \begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{picPerm1_edited}
    \end{subfigure}
\end{figure}
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{picPerm3_edited}
    \end{subfigure}%
    \begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{picPerm4_edited}
    \end{subfigure}
\end{figure}
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{picPerm5_edited}
    \end{subfigure}%
    \begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.78\textwidth]{picPerm6_edited}
    \end{subfigure}
...
\begin{figure}[ht]
	\centering
	\begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.9\textwidth]{picDual1_edited}
    \end{subfigure}%
    \begin{subfigure}{.4\textwidth}
		\includegraphics[width=0.9\textwidth]{picDual2_edited}
    \end{subfigure}
